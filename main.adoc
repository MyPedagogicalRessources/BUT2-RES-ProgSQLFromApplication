...
** Méthodes impliquées
*** _PDO::beginTransaction()_ pour initier la transaction
*** _PDO::commit()_ ou _PDO::rollBack()_ pour finir la transaction
...
----
<1> Bénéfice assurée en terme de performance : ouvrir une nouvelle connexion à une base de données est très couteux en comparaison à la réutilisation d'une connexion déjà ouverte !